...
import heroImg from '@/images/slider-scaled.webp';
export default function Hero() {
  return (
    <section className="pt-6.5" >
      {/* Overlay */}
      <div className='container md:mx-auto md:px-4  relative overflow-hidden' style={{ height: 'calc(100vh - 128px)' }}>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 drop-shadow-lg">
              مرحبا بكم في اجريسكو للاستشارات الزراعية
            </h2>
          </div>
        </div>
